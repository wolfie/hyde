...
var help = [
    ...
    '',
    'By default, SOURCEPATH is the current working directory. TARGETPATH is by',
    'default "$SOURCEPATH/_site".',
    '',
    '-s PATH, --sourcepath=PATH',
    '\tSets a SOURCEPATH explicitly.',
    '',
    '-t PATH, --targetpath=PATH',
    '\tSets a TARGETPATH explicitly.',
    '',
    '-v, --version',
