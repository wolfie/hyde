 ...
 * @param {!string[]} common The pathnames that were found in both the source
 *    and the target
 * @param {!string[]} missing The pathnames that were in source, but not in
 *    target
 * @param {!string[]} extra The pathnames that were not in source, but were in
 *    target
 */
...
var dirdiff = function(sourcePath, targetPath, done) {
  ...
  assertIsFunction(done, 'a callback needs to be given');
